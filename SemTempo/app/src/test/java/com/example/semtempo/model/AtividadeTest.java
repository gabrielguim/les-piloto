...
public class AtividadeTest {
    ...
    public void instanciacao(){
        ...
        atv1 = new Atividade("Chutar cu de bebo", p3, h0, Categoria.LAZER);
        atv2 = new Atividade("Comer pudim", p3, h0, Categoria.LAZER);
        atv3 = new Atividade("Escrever artigo de ES", p1, h0, Categoria.LAZER);
        atv4 = new Atividade("Escutar Polentinha do Arrocha", p2, h0, Categoria.LAZER);
    }
